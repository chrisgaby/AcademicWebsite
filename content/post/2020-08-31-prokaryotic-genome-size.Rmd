...
As an frame of reference, the familiar laboratory workhorse *Escherichia coli* K12 has a genome size of 4.64 Mb.
...
The list was downloaded as a csv file. Let's import the csv file and calculate some statistics for prokaryotic genome size.
...
Let's calculate some statistics for genome size:
...
Based upon the separated density plots, it looks as if the genome size varies by phylum. Let's see how much it varies by phylum:
...
Thus, it appears that phylum-dependent genome size variation ranges from 3.2 to 5.3 Mb.
