...
![The *E coli* K12 reference genome from NCBI prokaryotic genomes.](/img/EcoliGenome.png)
...
![The Criteria Selected to Obtain a List of NCBI Refseq Prokaryotic Genomes.](/img/RefSeqGenomes.png)
...
This webpage was composed using R Markdown, and the [Rmd file is available for download](/files/2020-08-31-prokaryotic-genome-size.Rmd) and may be viewed as a plain text file or by opening the file within RStudio.
